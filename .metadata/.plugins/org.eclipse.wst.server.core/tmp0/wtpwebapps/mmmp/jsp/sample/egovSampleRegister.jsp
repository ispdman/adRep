...
<head>
    ...
    <%-- <script type="text/javascript" src="<c:url value='/js/se2/js/service/HuskyEZCreator.js'/>" charset="utf-8"></script> --%>
    ...
    <div id="content_pop">
    	...
    	<table width="100%" border="1" cellpadding="0" cellspacing="0" style="bordercolor:#D3E2EC; bordercolordark:#FFFFFF; BORDER-TOP:#C2D0DB 2px solid; BORDER-LEFT:#ffffff 1px solid; BORDER-RIGHT:#ffffff 1px solid; BORDER-BOTTOM:#C2D0DB 1px solid; border-collapse: collapse;">
    		...
    		<tr>
    			...
    			<td class="tbtd_content">
    				 <form:textarea path="description" id="tarea" name="tarea" rows="10" cols="100"  style="width:690px;"/>&nbsp;<form:errors path="description" /> 
               ...
               <!--  <script type="text/javascript">
					 ...
					 oAppRef: oEditors,
					 elPlaceHolder: "tarea",
					 sSkinURI: "<c:url value='/js/se2/SmartEditor2Skin.html'/>",
